# Pyroselytism
A very rudimentary script for converting a large quantity of pdf-files to txt-files, with [pyPDF2](https://github.com/mstamy2/PyPDF2) as it's only dependency.
